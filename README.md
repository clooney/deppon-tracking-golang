# DEPPON Tracking API For Golang
DEPPON Tracking API and webhook make it easy to integrate DEPPON Tracking function into your own project. Support APIs Client Libraries for golang

### API key

In order to use this API, you need to generate a DEPPON Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use DEPPON Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [DEPPON Tracking API](https://www.trackingmore.com/deppon-tracking.html)  to:

   *   Get DEPPON realtime tracking info of muti-carriers in one integration
   *   Provide DEPPON shipment tracking experience like Amazon
   *   Push DEPPON notifications of package update with webhook
   *   Verify DEPPON delivery exception before it is too late
